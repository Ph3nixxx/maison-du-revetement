...
export default function CGV() {
    return (
        <section className="cgv">
            ...
            Livraison est effectuée par la remise directe de la marchandise au client :
            ...
            (10 €) par jour de retard commençant à courir à partir de la date de retrait indiquée sur bon de commande, sans autre formalité. TOUTE COMMANDE NON ENLEVÉE DANS LE
            ...
            SUBIS COMPRENANT NOTAMMENT LES FARIS SUS ENONCES.
            ...
            <p>Les délais de livraison étant fixés d'un commun accord par le vendeur et le client, si le
            délai indiqué sur le bon de commande est dépassé de plus de 7 jours, sauf cas de force
            ...
            <h2>DROIT APPLICABLE ET COMPETENCE</h2>
